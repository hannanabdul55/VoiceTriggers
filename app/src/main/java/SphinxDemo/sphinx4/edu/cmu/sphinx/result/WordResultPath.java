...
public class WordResultPath implements Path {
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.Path#getScore() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.Path#getConfidence() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.Path#getWords() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.Path#getTranscription() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.Path#getTranscriptionNoFiller() */
