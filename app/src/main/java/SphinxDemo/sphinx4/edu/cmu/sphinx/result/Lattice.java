 ...
 *
 */
package SphinxDemo.sphinx4.edu.cmu.sphinx.result;

import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.AlternateHypothesisManager;
import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.Token;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.WordSearchState;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Pronunciation;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Word;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.LogMath;
...
/**
 * <p/>
 * Provides recognition lattice results. Lattices are created from {@link SphinxDemo.sphinx4.edu.cmu.sphinx.result.Result Results} which
 ...
 * graph containing {@link SphinxDemo.sphinx4.edu.cmu.sphinx.result.Node Nodes} and {@link SphinxDemo.sphinx4.edu.cmu.sphinx.result.Edge Edges}. A Node that
 ...
 * AlternativeHypothesisManager). Currently, only the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}
 * has an AlternativeHypothesisManager. Furthermore, the lattice construction code currently only works for linguists
 * where the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.WordSearchState} returns false on the <code>isWordStart</code> method, i.e.,
 * where the word states appear at the end of the word in the linguist. <i>Therefore, lattices should only be created
 * from Result from the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.lextree.LexTreeLinguist} and the {@link
 * SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}. </i> </p>
 * <p/>
 * Lattices can also be created from a collapsed {@link SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.Token} tree and its
 ...
 * task of collapsing the token tree is done by the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}.
