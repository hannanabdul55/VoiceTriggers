 ...
 *
 */
package SphinxDemo.sphinx4.edu.cmu.sphinx.recognizer;

import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.Decoder;
import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.ResultProducer;
import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.ResultListener;
import SphinxDemo.sphinx4.edu.cmu.sphinx.instrumentation.Monitor;
import SphinxDemo.sphinx4.edu.cmu.sphinx.instrumentation.Resetable;
...
public class Recognizer implements Configurable, ResultProducer {
    ...
    public Recognizer(Decoder decoder, List<Monitor> monitors) {
        ...
        name = null;
        System.out.println("INSIDE RECOGNIZER!!!");
    }
