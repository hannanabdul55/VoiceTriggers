...
public class WordActiveListFactory extends ActiveListFactory {
    ...
    * (non-Javadoc)
    *
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.ActiveListFactory#newInstance()
    */
    @Override
    ...
    class WordActiveList implements ActiveList {
        ...
        /* (non-Javadoc)
        * @see SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.ActiveList#createNew()
        */
        @Override
        public ActiveList newInstance() {
