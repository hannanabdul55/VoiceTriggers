...
*/
package SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.classes;
...
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.props.S4Component;
...
public class ClassBasedLanguageModel implements LanguageModel {
     ...
     * (non-Javadoc)
     *
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram.LanguageModel#allocate()
     */
    @Override
    ...
    * (non-Javadoc)
    *
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram.LanguageModel#deallocate()
    */
    @Override
     ...
     * P=P(W|C1)*P(C1|C2,C3..)
     *
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram.LanguageModel#getProbability(SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.WordSequence)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram.LanguageModel#getVocabulary()
     */
    @Override
