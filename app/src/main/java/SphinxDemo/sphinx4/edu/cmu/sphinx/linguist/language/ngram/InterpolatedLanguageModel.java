 ...
 */
package SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram;
...
public class InterpolatedLanguageModel implements LanguageModel {
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram.LanguageModel#getSmear(SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.WordSequence)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.ngram.LanguageModel#getMaxDepth()
     */
    @Override
