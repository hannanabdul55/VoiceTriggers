...
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.WordClassification;
...
public class ClassPresentingDictionary implements Dictionary {
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#getSentenceStartWord()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#getSentenceEndWord()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#getSilenceWord()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#getPossibleWordClassifications()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#getFillerWords()
     */
    @Override
