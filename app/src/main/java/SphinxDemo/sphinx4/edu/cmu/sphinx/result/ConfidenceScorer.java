 ...
 * SphinxDemo.sphinx4.edu.cmu.sphinx.result.MAPConfidenceScorer} returns the highest scoring path. On the other hand, the {@link
 * SphinxDemo.sphinx4.edu.cmu.sphinx.result.SausageMaker} returns the path where all the words have the highest confidence in their
