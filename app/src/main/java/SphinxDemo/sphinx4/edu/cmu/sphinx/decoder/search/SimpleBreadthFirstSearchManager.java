 ...
 *
 */
package SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search;

import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.pruner.Pruner;
import SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.scorer.AcousticScorer;
...
public class SimpleBreadthFirstSearchManager extends TokenSearchManager {
    ...
    public Result recognize(int nFrames) {
        ...
        if (activeList.getBestToken() != null) {
            ...
            System.out.println(activeList.getBestToken());
        ...
        System.out.println("SM.recognize()-------"+result);
        return result;
    }
...
//        }
    ...
    * (non-Javadoc)
    *
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.SearchManager#allocate()
    */
    @Override
    ...
    * (non-Javadoc)
    *
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.SearchManager#deallocate()
    */
    @Override
