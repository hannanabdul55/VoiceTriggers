 ...
 * creates a {@link SphinxDemo.sphinx4.edu.cmu.sphinx.result.Lattice} from the result first, which means that you should only use this
 * confidence scorer if the result is created from the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.lextree.LexTreeLinguist} and the
 * {@link SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}.
 */
