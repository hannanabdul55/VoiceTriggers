...
public class SimpleWordListGrammar extends Grammar implements Configurable {
    ...
    public SimpleWordListGrammar(String path, boolean isLooping, LogMath logMath, boolean showGrammar, boolean optimizeGrammar, boolean addSilenceWords, boolean addFillerWords, SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary dictionary) {
