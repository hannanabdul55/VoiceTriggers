...
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.Linguist;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.SearchGraph;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.SearchState;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.SearchStateArc;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.acoustic.*;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary;
...
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.grammar.Grammar;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.grammar.GrammarArc;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.language.grammar.GrammarNode;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.Cache;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.LogMath;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.StatisticsVariable;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.TimerPool;
...
public class FlatLinguist implements Linguist, Configurable {
    ...
    */
     ...
     * @throws SphinxDemo.sphinx4.edu.cmu.sphinx.util.props.PropertyException
     */
    ...
    * (non-Javadoc)
    *
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.Linguist#allocate()
    */
    @Override
    ...
    * (non-Javadoc)
    *
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.Linguist#deallocate()
    */
    @Override
    ...
    protected class FlatSearchGraph implements SearchGraph {
        ...
        * (non-Javadoc)
        *
        * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.SearchGraph#getInitialState()
        */
        @Override
        ...
        * (non-Javadoc)
        *
        * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.SearchGraph#getNumStateOrder()
        */
        @Override
...
//                    int maxSize = getRightContextSize();
            ...
            //System.out.println(startingContexts);
