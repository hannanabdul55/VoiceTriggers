...
public class SimpleWordResult implements WordResult {
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getScore() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getConfidence() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getLogMath() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getPronunciation() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getStartFrame() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getEndFrame() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#getDataFrames() */
    @Override
    ...
    /** @see SphinxDemo.sphinx4.edu.cmu.sphinx.result.WordResult#isFiller() */
    @Override
