...
*
*/
package SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.util;

import SphinxDemo.sphinx4.edu.cmu.sphinx.util.BatchFile;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.ReferenceSource;
 ...
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.DataStartSignal DataStartSignal} will be placed before the start of the first file, and a
 * {@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.DataEndSignal DataEndSignal} after the last file. No DataStartSignal or DataEndSignal
 * will be placed between them. Optionally, silence can be added in-between the audio files by setting the property:
 * <pre>SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.util.ConcatFileDataSource.silenceFile</pre>
