...
package SphinxDemo.sphinx4.edu.cmu.sphinx.frontend;
 ...
 * <p/>
 * Each such data processor implements the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.DataProcessor} interface. Objects that
 * implements the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.Data} interface enters and exits the front end, and go between the
 ...
 * separately, and use the {@link #setDataSource(SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.DataProcessor) setDataSource} method to set it
 * as the input DataProcessor. In that case, the input DataProcessor will be prepended to the existing chain of
 * DataProcessors. One common input DataProcessor is the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.util.Microphone}, which
 ...
 * <p/>
 * Another common input DataProcessor is the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.util.StreamDataSource}. It turns a Java
 ...
 * <p/>
 * <pre>
 * &lt;component name="mfcFrontEnd" type="SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.FrontEnd"&gt;
 ...
 * &lt;/component&gt;
 * <p/>
 * &lt;component name="preemphasizer" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.filter.Preemphasizer
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.filter.Preemphasizer}"/&gt;
 * &lt;component name="windower" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.window.RaisedCosineWindower
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.window.RaisedCosineWindower}"/&gt;
 * &lt;component name="dft" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.transform.DiscreteFourierTransform
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.transform.DiscreteFourierTransform}"/&gt;
 * &lt;component name="melFilterBank" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank}"/&gt;
 * &lt;component name="dct" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.transform.DiscreteCosineTransform
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.transform.DiscreteCosineTransform}"/&gt;
 * &lt;component name="batchCMN" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.feature.BatchCMN
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.feature.BatchCMN}"/&gt;
 * &lt;component name="featureExtractor" type="{@link SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.feature.DeltasFeatureExtractor
 * SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.feature.DeltasFeatureExtractor}"/&gt;
 * </pre>
 * <p/>
 ...
 * <p/>
 * <pre>
 * &lt;component name="scorer" type="SphinxDemo.sphinx4.edu.cmu.sphinx.decoder.scorer.SimpleAcousticScorer"&gt;
 *     &lt;property name="frontend" value="mfcFrontEnd"/&gt;
 * &lt;/component&gt;
 * </pre>
 * <p/>
 * In the SimpleAcousticScorer, the front end is obtained in the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.util.props.Configurable#newProperties
...
public class FrontEnd extends BaseDataProcessor {
    ...
    /* (non-Javadoc)
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.DataProcessor#initialize(SphinxDemo.sphinx4.edu.cmu.sphinx.frontend.CommonConfig)
    */
    @Override
    ...
    public List<DataProcessor> getElements() {
        System.out.println(frontEndList);
        return frontEndList;
    }
