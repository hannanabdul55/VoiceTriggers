 ...
 * has a set of entering and leaving {@link SphinxDemo.sphinx4.edu.cmu.sphinx.result.Edge edges}, connecting it to other nodes. One can get
 ...
 * Forward-Backward Algorithm. Refer to the {@link SphinxDemo.sphinx4.edu.cmu.sphinx.result.Lattice#computeNodePosteriors
