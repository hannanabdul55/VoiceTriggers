 ...
 *
 */
package SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary;

import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.acoustic.Context;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.acoustic.Unit;
import SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.acoustic.UnitManager;
import SphinxDemo.sphinx4.edu.cmu.sphinx.util.ExtendedStreamTokenizer;
...
public class FullDictionary implements Dictionary {
    ...
    */
    ...
    /* (non-Javadoc)
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#allocate()
    */
    @Override
    ...
    /* (non-Javadoc)
    * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Dictionary#deallocate()
    */
    @Override
     ...
     * @see SphinxDemo.sphinx4.edu.cmu.sphinx.linguist.dictionary.Word
     */
    @Override
